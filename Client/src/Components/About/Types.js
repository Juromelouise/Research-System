        ...
        <div className="container-fluid header bg-white p-0">
          <div className="row g-0 align-items-center flex-column-reverse flex-md-row">
            <div className="col-md-6 p-5 mt-lg-5">
              ...
              <p className="animated fadeIn mb-4 pb-2">
              The yellow varieties grown for the traditional market are either the granex (flat) or 
              the grano (round) type, short day onions.
              White onions are characterized by their milder, sweeter taste and tender
               texture, making them suitable for raw applications like salads, salsas, 
               and sandwiches. Conversely, yellow onions offer a stronger, more robust flavor 
               that holds its structure well during cooking, making them ideal for sautéed onion dishes, 
                  ...
                  <div className="row g-0 align-items-left flex-column-reverse flex-md-row">
                    ...
                    <div className="col-md-6 p-5 mt-lg-5 animated fadeIn">
                      <div>
                        ...
                        <p className="mb-4 pb-2">
                        Shallot, locally known as “sibuyas Tagalog,” is a spice crop extensively grown in the 
                        country primarily for culinary purposes. In contrast to other onion types, 
                        shallot has a milder and more subtle flavor, which makes it a good ingredient 
                        for pickling and garnishing.Shallots actually come in both red and yellow skins just like onions. 
                        However, peel back those dried-up skins and you’re likely to find what looks like 
                        a narrow red onion that’s not quite as purple as a red onion usually is.The shallot is not only 
                        different in shape but also in how it grows. Like garlic, the shallot grows in clusters of two or more. 
                        That’s why when you slice a shallot in half, you can expect to find two separate halves of a 
                        bulb in what seems to be a single bulb
                        </p>
                      </div>
                    </div>
                  </div>
